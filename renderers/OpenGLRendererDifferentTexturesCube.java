...
public class OpenGLRendererDifferentTexturesCube implements GLSurfaceView.Renderer {
    // 10 секунд
     ...
     */
    public OpenGLRendererDifferentTexturesCube(Context context, int width, int height) {
    ...
    public void onDrawFrame(GL10 arg0) {
        ...
        GraphicTricks.draw(boxNear,   texture);
        GraphicTricks.draw(boxFar,    texture);
        GraphicTricks.draw(boxTop,    texture);
        //GraphicTricks.draw(boxBottom, texture);
        GraphicTricks.draw(boxLeft,   texture);
        GraphicTricks.draw(boxRight,  texture);
    }
