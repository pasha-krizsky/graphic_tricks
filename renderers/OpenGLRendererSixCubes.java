 ...
 */
public class OpenGLRendererSixCubes implements Renderer {
     ...
     */
    public OpenGLRendererSixCubes(Context context, int width, int height) {
    ...
    public void onDrawFrame(GL10 arg0) {
        ...
        model.drop();
        model.move(-1f, 1.5f, -2f);
        model.rotateAroundZ(angle3);
